            ...
            {canDelete &&
                <div className="transaction-content">
                    ...
                    <div className="transaction-amount-settings enabled">
                        <p style={{color:transaction.transactionType === 'contribution' ? 'var(--color-green-primary)' : 'var(--color-red-primary)'}}>{formatCurrency(Number(transaction.amount))}</p>
            ...
            {!canDelete &&
                <div className="transaction-content">
                    ...
                    <div className="transaction-amount-settings disabled">
                        ...
                        <p style={{color: 'var(--color-green-primary)'}}>{formatCurrency(Number(transaction.amount))}</p>
                        }
                        {transaction.transactionType === 'transfer_out' &&
                        <p style={{color: 'var(--color-red-primary)'}}>{formatCurrency(Number(transaction.amount))}</p>
                        }
                        {transaction.transactionType === 'adjustment' &&
                        <p style={{color: 'var(--color-icon-muted)'}}>{formatCurrency(Number(transaction.amount))}</p>
                        }
